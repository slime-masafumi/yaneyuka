...
Claude Code が起動時に自動で読む。**自律的に進め、◆Project管理 への共有は確認せずに行う。**
...
- **振る舞い**は `C:\Users\slime\.claude\CLAUDE.md`(自動読込)。**手順**は `C:\Users\slime\.claude\skills\<name>\SKILL.md` を該当場面で読む
