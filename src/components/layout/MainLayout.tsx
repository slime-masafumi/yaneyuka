...
import ContactsManagement from '../content/ContactsManagement';
import DesignTools from '../content/Userpage/DesignTools';
import DesignInfo from '../content/DesignInfo';
import MaterialInfo from '../content/Userpage/design-tools/MaterialInfo';
