/**
 * 建材Chatbot の手書きデータ（代表的な製品と、よくある質問への短い答え）。
 * 以前は Chatbot.tsx に直書きしていたもの。基本知識の本体は knowledge.json（建材ページから自動で書き出す）。
 */
...
export const productData: Record<string, Record<string, Product[]>> = {
  '屋根': {
    '折板': [
